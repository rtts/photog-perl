...
Examples:
 ...
 DateTime::Locale->register
     ( id               => 'hu_HU',
       ...
       native_territory => 'MagyarorszÃ¡g',
     );
...
MagyarorszÃ¡g". The locale will be loadable by these complete names
...
Chinese characters for "day" (æ¥) and month (æ), so you get something like
"8æ23æ¥".
